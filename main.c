...
#pragma config FOSC=HS, WDTE=OFF, PWRTE=ON, MCLRE=ON, CP=OFF, CPD=OFF, BOREN=ON, CLKOUTEN=OFF, IESO=OFF, FCMEN=OFF
#pragma config WRT=OFF, VCAPEN=OFF, PLLEN=ON, STVREN=ON, BORV=LO, LVP=OFF
